...
const SITE = {"name":"COMMIT","site":"https://commit.agency","base":"/","trailingSlash":false,"googleSiteVerificationId":"orcPxI47GSa-cRvY11tUe6iGg2IO_RPvnA1q95iEM3M"};
                    const I18N = {"language":"es","textDirection":"ltr"};
                    const METADATA = {"title":{"default":"COMMIT - Agencia de Desarrollo de Software","template":"%s | COMMIT"},"description":"Agencia especializada en desarrollo de aplicaciones web y móviles. Creamos soluciones digitales personalizadas para startups y empresas. Apps, webapps, MVPs y sistemas a medida.","openGraph":{"type":"website","site_name":"COMMIT","images":[{"url":"~/assets/images/default.png","width":1200,"height":630}],"locale":"es_ES"},"twitter":{"handle":"@commit_agency","site":"@commit_agency","cardType":"summary_large_image"}};
...
export { APP_BLOG as A, BLOG_BASE as B, CATEGORY_BASE as C, DEFAULT_OUTPUT_FORMAT as D, I18N as I, METADATA as M, POST_PERMALINK_PATTERN as P, SITE as S, TAG_BASE as T, UI as U, VALID_SUPPORTED_FORMATS as V, getPermalink as a, getBlogPermalink as b, getAsset as c, getCanonical as d, DEFAULT_HASH_PROPS as e, VALID_INPUT_FORMATS as f, getHomePermalink as g, cleanSlug as h, getFormattedDate as i, trimSlash as t };
