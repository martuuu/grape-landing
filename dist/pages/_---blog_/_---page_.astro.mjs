...
import { e as getStaticPathsBlogList, h as blogListRobots } from '../../chunks/blog_Q2g5McDo.mjs';
...
` })} ${renderComponent($$result2, "BlogList", $$List, { "posts": page.data })} ${renderComponent($$result2, "Pagination", $$Pagination, { "prevUrl": page.url.prev, "nextUrl": page.url.next })} <!--
    ...
    --> </section> ` })}`;
}, "/Users/martinnavarro/Documents/commit-landing/grape-landing/src/pages/[...blog]/[...page].astro", void 0);

const $$file = "/Users/martinnavarro/Documents/commit-landing/grape-landing/src/pages/[...blog]/[...page].astro";
const $$url = "/[...blog]/[...page]";
