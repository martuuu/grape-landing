...
const $$Services = createComponent(($$result, $$props, $$slots) => {
  ...
  const metadata = {
    ...
    description: "Desarrollo de aplicaciones web, m\xF3viles, MVPs y sistemas a medida. Soluciones tecnol\xF3gicas personalizadas para startups y empresas en crecimiento.",
    canonical: "https://commit.agency/services",
    openGraph: {
      title: "Servicios de Desarrollo | COMMIT",
      description: "Apps web, m\xF3viles, MVPs y sistemas personalizados. Tecnolog\xEDa de vanguardia para tu negocio.",
      type: "website"
    }
  };
...
}, "/Users/martinnavarro/Documents/commit-landing/grape-landing/src/pages/services.astro", void 0);

const $$file = "/Users/martinnavarro/Documents/commit-landing/grape-landing/src/pages/services.astro";
const $$url = "/services";
